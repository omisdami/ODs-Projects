...
plt.title('Brisk Walking(Accelerometer Unfiltered Data)')
plt.legend()
...
plt.title('Brisk Walking(Gyroscope Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
...
plt.title('Brisk Walking(Magnetometer Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
