...
plt.title('Sitting and Talking(Accelerometer Unfiltered Data)')
plt.legend()
...
plt.title('Sitting and Talking(Gyroscope Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
...
plt.title('Sitting and Talking(Magnetometer Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
