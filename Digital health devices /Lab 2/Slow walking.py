...
plt.title('Slow Walking(Accelerometer Unfiltered Data)')
plt.legend()
...
plt.title('Slow Walking(Gyroscope Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
...
plt.title('Slow Walking(Magnetometer Unfiltered Data)')
plt.legend()
plt.xlabel('Timestamp')  # Add x-axis label
plt.ylabel('Sensor Readings')  # Add y-axis label
